    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" @click="clearDrugView()"></button>
        </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createAppointmentModalLabel">
            <img src="https://png.pngtree.com/element_our/png/20181114/business-deadline-icon-png_239815.jpg" style="height:25px" class="me-2"/>
            {{appointmentViewDetails.title}}
          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" @click="clearAppointmentView()"></button>
        </div>
        <div class="modal-body">
            ...
            <ion-list>
              ...
              <ion-item>
                <ion-label>
                  ...
                  <select class="form-select w-100" aria-label="Default select example" v-model="selectedAgenda" required>
